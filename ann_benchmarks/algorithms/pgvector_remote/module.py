...
class PGVector_Remote(BaseANN):
    ...
    def fit(self, X):
        ...
        if self._metric == "angular":
            ...
            cur.execute("CREATE INDEX ON items USING pinecone (embedding vector_l2_ops) WITH (spec = '{\"serverless\":{\"cloud\":\"aws\",\"region\":\"us-west-2\"}})" % (self._m, self._ef_construction))
        else:
